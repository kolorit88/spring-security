...
import org.example.example.application.service.OrderServiceImpl
...
class OrderServiceImplTest {
    ...
    private val testUser = domain.model.User(
        id = 1L,
    ...
    private val testDish1 = domain.model.Dish(
        id = 1L,
        name = "Pizza",
    ...
    private val testDish2 = domain.model.Dish(
        id = 2L,
        name = "Pasta",
